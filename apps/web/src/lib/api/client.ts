...
export const batchApi = {
  ...
  getBuyerDashboard: () => apiGet(apiRoutes.buyerDashboard, { headers: roleHeaders("BUYER") }),
  listBuyerCommitments: () => apiGet(apiRoutes.buyerCommitments, { headers: roleHeaders("BUYER") }),
