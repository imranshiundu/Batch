...
export function GET() {
  return ok({
    ...
    basePath: "/api",
    auth: {
      current: "demo-role-header plus optional x-batch-bot-scopes",
    ...
    routes: [
      ...
      { method: "POST", path: "/market/orders", scope: "orders:create", purpose: "Submit a market-style instruction for a batch commitment or slot transfer." },
